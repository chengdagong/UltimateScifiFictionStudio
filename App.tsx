...
const App: React.FC = () => {
  // App State
  const [activeTab, setActiveTab] = useState<'participants' | 'timeline' | 'story' | 'chronicle' | 'tech'>('participants');
