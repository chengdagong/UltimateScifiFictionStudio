...
const TimelineView: React.FC<TimelineViewProps> = ({ model, storySegments, framework }) => {
  ...
  useEffect(() => {
    ...
    try {
        ...
        // Initial transform
        svg.call(zoom.transform, d3.zoomIdentity.translate(50, 80).scale(0.8));
